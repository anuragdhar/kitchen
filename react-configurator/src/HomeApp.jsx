  ...
  return <main style={{minHeight:'calc(100vh - 68px)',background:'linear-gradient(145deg,#f5f3ff,#f7fee7)',padding:'clamp(24px,5vw,64px) clamp(14px,4vw,40px)'}}>
    <div style={{maxWidth:1100,margin:'0 auto'}}>
      ...
      <div style={{marginTop:20,display:'grid',gap:10}}>
        ...
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>North-wall cabinet:</b> the upper cabinet begins at the ceiling and is {office.cabinetry.northWall.upper.sourceLabels.height} high × {office.cabinetry.northWall.upper.sourceLabels.depth} deep. Directly below it, the cabinet steps back to {office.cabinetry.northWall.lower.sourceLabels.depth} deep and measures {office.cabinetry.northWall.lower.sourceLabels.height} high × {office.cabinetry.northWall.lower.sourceLabels.width} wide.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>Cabinet fronts:</b> one lift-up flap on the upper cabinet. The tall lower cabinet splits horizontally at the tabletop line, with two-panel bypass sliding doors in both the upper and lower sections. The fixed south run uses hinged cabinet doors, including an opening door at the southwest corner.</div>
        ...
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>Adjustable workstation:</b> a custom 190 × 76.2 cm west desktop on the unchanged 129 cm FLEXISPOT frame, adjustable from 29 to 47.6 inches with a 33-inch seated preset. The top overhangs about 30.5 cm at both ends and stops roughly 6 cm before the straight south cabinet. This custom width exceeds the manufacturer’s stated 160 cm tabletop limit and needs structural validation.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>Rear storage:</b> the lower cabinet is a uniform 18 inches deep, leaving the owner-preferred 12 inches of open leg depth beneath the 30-inch desktop. The previous deeper end pods have been removed.</div>

...
function StudyWorkspace(){
  ...
  return <main style={{minHeight:'calc(100vh - 68px)',background:'#eef3f6',padding:'clamp(24px,5vw,64px) clamp(14px,4vw,40px)'}}>
    <div style={{maxWidth:1100,margin:'0 auto'}}>
      ...
      <p style={{fontSize:19,lineHeight:1.55,maxWidth:720,color:'#566174'}}>The room shell is ready. We can shape the study together before adding detailed plans, elevations and 3D views.</p>
  ...
  return <main style={{minHeight:'calc(100vh - 68px)',background:'linear-gradient(145deg,#f5f3ff,#f7fee7)',padding:'clamp(24px,5vw,64px) clamp(14px,4vw,40px)'}}>
    <div style={{maxWidth:1100,margin:'0 auto'}}>
      ...
      <div style={{marginTop:20,display:'grid',gap:10}}>
        ...
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>North-wall cabinet:</b> the upper cabinet begins at the ceiling and is {office.cabinetry.northWall.upper.sourceLabels.height} high × {office.cabinetry.northWall.upper.sourceLabels.depth} deep. Its east bay conceals the existing water heater behind removable ventilated access, while the adjacent west bay holds the router on a ventilated shelf with an internal socket and solid divider. Directly below it, the cabinet steps back to {office.cabinetry.northWall.lower.sourceLabels.depth} deep and measures {office.cabinetry.northWall.lower.sourceLabels.height} high × {office.cabinetry.northWall.lower.sourceLabels.width} wide. The heater dimensions and manufacturer clearances must be verified on site before fabrication.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>Cabinet fronts:</b> one lift-up flap on the upper cabinet. The tall lower cabinet splits horizontally at the tabletop line, with two-panel bypass sliding doors in both the upper and lower sections. The west-side lower run has east-facing access; the south wall remains fully open.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>North cabinet access:</b> the cabinet remains 3 feet wide, with full-width bypass sliders in the lower section and no corner filler or swing-clearance conflict beside the adjustable workstation.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>Adjustable workstation:</b> a custom 226.8 × 76.2 cm west desktop on the unchanged 129 cm FLEXISPOT frame, adjustable from 29 to 47.6 inches with a 33-inch seated preset. The top now continues from the north cabinet to the south wall, with about 48.9 cm overhang at each end of the frame. The separate south-wall counter has been removed. This custom width exceeds the manufacturer’s stated 160 cm tabletop limit and needs structural validation.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>West-side storage:</b> the lower cabinet is a uniform 1 foot deep and runs from the north cabinet to the south end. Its fronts face east toward the seated user, leaving about 18 inches of open floor depth beneath the 30-inch desktop. The south wall has no counter or cabinet.</div>
        <div style={{padding:18,borderRadius:16,background:'#fff',border:'1px solid #ded8ea',color:'#5f5870',fontSize:14}}><b style={{color:'#231942'}}>Monitor setup:</b> dual-arm stand on the west-side worktop, shifted 6 inches left/south from the north-end position, with both screens facing the person; Lenovo D32qc-20 31.5-inch QHD display on the right, shown as a simple straight screen by owner request, and BenQ GW2490 23.8-inch FHD display on the left.</div>

export const EMPTY_ROOM_SHELLS={
  bedroom1:{
    ...
    balconyExtension:{wall:'east',depthMm:1200,lengthMm:2200,railingHeightMm:1000,frameStyle:'aluminium'},
    doors:[
      {wall:'north',fromMm:766,widthMm:650,heightMm:2100,leadsTo:'Bedroom 1 washroom'},
      {wall:'south',fromMm:2350,widthMm:900,heightMm:2100,leadsTo:'Lobby / Dining'},
    ],
  },
  ...
  lobby:{
    ...
    poojaAlcove:{wall:'north',fromMm:3793,widthMm:1200,depthMm:1000},
    furniture:{diningTable:{centerXmm:2900,centerZmm:1650,widthMm:700,lengthMm:1200,heightMm:745},chairRowsZmm:[1320,1980],chairOffsetXmm:620},
    doors:[
      {wall:'south',fromMm:1000,widthMm:900,heightMm:2100,leadsTo:'Toilet'},
      {wall:'north',fromMm:2350,widthMm:900,heightMm:2100,leadsTo:'Bedroom 1'},
    ],
  },
  drawing:{

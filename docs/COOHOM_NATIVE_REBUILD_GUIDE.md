...
1. In the React app, click `Export 2D SVG`, `Export 2D PNG`, or `Export 2D DXF`.
2. In Coohom Floorplanner, import the exported file as a plan/background reference.
3. Set the scale using the full room size: 2324 mm wide x 4746 mm long.
